...
REQUIRED_PARAMS = (
    ...
    "remaining_15c_budget",
    "remaining_17c_budget",
    "remaining_2c_budget",
    ...
    "fid_delay_low",
    "fid_delay_high",
    "lifespan_sensitivity_low",
    "lifespan_sensitivity_high",
    "lca_howarth_gwp20_low",
    "lca_howarth_gwp20_high",
    "lca_roman_white_w2r_p025",
    "lca_roman_white_w2r_expected",
    "lca_roman_white_w2r_p975",
    "lca_balcombe_lng_stages_low_g_per_mj_hhv",
    "lca_balcombe_lng_stages_high_g_per_mj_hhv",
    "lca_hhv_mj_per_kg",
    "placeholder_sensitivity_years",
)
