...
> **Current lock:** **7,167.1 Mt** lifetime CO2e, **235.9 Mt** peak in 2037, **18.2 / 3.2 / 78.6** CAN / BUNK / FOR, **C$3,106 bn** ECCC 2% damages valued when caused (**C$1,945 bn** discounted to 2025), **79.6 mtpa** of export capacity; well-to-regasification **0.78 tCO2e/t LNG**.
