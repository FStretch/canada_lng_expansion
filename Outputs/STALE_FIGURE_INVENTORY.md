...
|---|---|---|---|---|
| 9,558.2 Mt lifetime (all assets) | 9,298.1 Mt | export-scope filter, then route-scaled shipping | **none** | `build_results.py`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
| 309.1 Mt peak (all assets) | 298.2 Mt in 2037 | export-scope filter, then route-scaled shipping | **none** | `build_results.py`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
...
| 9,315.3 Mt lifetime (export scope, flat shipping) | 9,298.1 Mt | Task 4, route-scaled shipping | **none** | `build_results.py`, `Outputs/BASELINE_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/PUBLICATION_AUDIT.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
| 298.7 Mt peak (flat shipping) | 298.2 Mt in 2037 | Task 4, route-scaled shipping | **none** | `build_results.py`, `Outputs/BASELINE_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
...
| 9,298.1 Mt lifetime (Discovery counted as early_proposed) | 7,254.2 Mt | Discovery returned to cancelled | **none** | `build_results.py`, `README.md`, `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/DECK_RECONCILIATION.md [banner]`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/PUBLICATION_AUDIT.md`, `Outputs/SOURCING_AUDIT.md [banner]`, `Outputs/SOURCING_AUDIT.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `src/banners.py`, `tools/stale_figure_inventory.py` |
| 298.2 Mt peak (Discovery in) | 238.6 Mt in 2037 | Discovery returned to cancelled | **none** | `build_results.py`, `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/DECK_RECONCILIATION.md [banner]`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/PUBLICATION_AUDIT.md`, `Outputs/SOURCING_AUDIT.md [banner]`, `Outputs/STALE_FIGURE_INVENTORY.md`, `src/banners.py`, `tools/stale_figure_inventory.py` |
...
| 18.1 / 3.2 / 78.7 territorial | 18.1 / 3.2 / 78.8 | Discovery returned to cancelled | **none** | `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/PUBLICATION_AUDIT.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py`, `tools/update_data_inputs_readme_task4.py` |
| C$4,073bn ECCC 2% damages (Discovery in) | C$3,143bn | Discovery returned to cancelled | **none** | `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/DECK_RECONCILIATION.md [banner]`, `Outputs/DECK_RECONCILIATION.md`, `Outputs/SOURCING_AUDIT.md [banner]`, `src/banners.py` · data series (not published text): `Outputs/figure_data/mc_draws.csv` |
...
| 100.1 mtpa export capacity (ten projects) | 80.1 mtpa (nine projects) | Discovery returned to cancelled | **none** | `README.md`, `Outputs/BASELINE_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-08-29.md`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/DECK_RECONCILIATION.md [banner]`, `Outputs/SOURCING_AUDIT.md [banner]`, `Outputs/STALE_FIGURE_INVENTORY.md`, `src/banners.py`, `tools/stale_figure_inventory.py`, `tools/update_chains_applies_to.py` |
...
| 7,254.2 Mt lifetime (regasification 0.04) | 7,215.3 Mt | regasification 0.04 -> 0.021 | **none** | `build_results.py`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/CHANGE_REPORT_2026-09-03b.md`, `Outputs/PUBLICATION_AUDIT.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` · data series (not published text): `Outputs/figure_data/mc_draws.csv` |
| 238.6 Mt peak (regasification 0.04) | 237.3 Mt in 2037 | regasification 0.04 -> 0.021 | **none** | `build_results.py`, `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/CHANGE_REPORT_2026-09-03b.md`, `Outputs/PUBLICATION_AUDIT.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
...
| C$3,143bn ECCC 2% damages (regasification 0.04) | C$3,126bn | regasification 0.04 -> 0.021 | **none** | `Outputs/CHANGE_REPORT_2026-09-03.md`, `Outputs/CHANGE_REPORT_2026-09-03b.md`, `Outputs/PUBLICATION_AUDIT.md` · data series (not published text): `Outputs/figure_data/mc_draws.csv` |
...
| 6,895.6 Mt CO2-only (ch4 share 0.30) | 6,918.1 Mt | upstream_ch4_share 0.30 -> 0.25 | **none** | `Outputs/CHANGE_REPORT_2026-09-03c.md`, `Outputs/CHANGE_REPORT_2026-09-03d.md`, `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
| 8,942 kt CH4 (ch4 share 0.30) | 8,186 kt | upstream_ch4_share 0.30 -> 0.25 | **none** | - |
| C$3,103bn ECCC 2% damages (ch4 share 0.30) | C$3,108bn | upstream_ch4_share 0.30 -> 0.25 | **none** | - |
| GWP20 scenario upstream 0.428 (share 0.30) | 0.393 (share 0.25) | upstream_ch4_share 0.30 -> 0.25 | **none** | `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
| FID delay band tested across 3 to 7 years | 4 to 8 years, asymmetric | slippage runs one way | **none** | `Outputs/STALE_FIGURE_INVENTORY.md`, `tools/stale_figure_inventory.py` |
