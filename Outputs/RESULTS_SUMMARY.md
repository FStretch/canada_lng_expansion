...
Default scenario: `measurement_central`. Run at 2026-08-29 09:55 UTC. Numbers to one decimal. Inputs read-only. `calc_group` from `Asset Register:calc_group`.
